...
class TestMoneyField:
    def get_serializer(
        self, model_class, instance=None, data=fields.empty, fields_="__all__"
    ):
    ...
    def test_invalid_value(self):
        serializer = self.get_serializer(
            ModelWithVanillaMoneyField, data={"money": None}
        )
    ...
    def test_serializer_with_fields(self):
        serializer = self.get_serializer(
            ModelWithVanillaMoneyField, data={"money": "10.00"}, fields_=("money",)
        )
